...
/**
 *  初始化传入相应参数，app启动时调用 -- 回调Adv_Data数组
 *
 ...
 *
 */
+(void)init:(NSString *)Gateway InstallEventName:(NSString *)InstallEventName IsNewUser: (BOOL)IsNewUser AppName: (NSString *)AppName success : (void(^)(NSArray * array))block DEPRECATED_MSG_ATTRIBUTE("请尽快使用HM_Web2App类中的方法上报事件，当前这个类下版本(3.1)开始不再维护");
 ...
 *  获取服务器最新Adv_Data
 */
+(void)GetPageData : (void(^)(NSArray *ad_data))block DEPRECATED_MSG_ATTRIBUTE("请尽快使用HM_Web2App类中的方法获取数据，当前这个类下版本(3.1)开始不再维护");
 ...
 */
+(void) Purchase:(NSString *) eventName Currency : (NSString *) currency Value : (NSString *) value ContentType : (NSString *) contentType ContentIds : (NSString *) contentIds Po_Id : (NSString *)po_id DEPRECATED_MSG_ATTRIBUTE("请尽快使用HM_Web2App类中的方法上报事件，当前这个类下版本(3.1)开始不再维护");
 ...
 */
+(void) EventPost:(NSString *)eventID EventName : (NSString *) eventName Currency : (NSString *) currency Value : (NSString *) value ContentType : (NSString *) contentType ContentIds : (NSString *) contentIds DEPRECATED_MSG_ATTRIBUTE("请尽快使用HM_Web2App类中的方法上报事件，当前这个类下版本(3.1)开始不再维护");
